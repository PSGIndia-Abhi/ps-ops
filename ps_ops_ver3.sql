...
--
-- Host: mysql
-- Generation Time: Apr 03, 2026 at 06:35 PM
...
('1b6853cf-43a6-4372-be83-3ffaba27680b', '3f7d8bd4-7fb8-4f2e-95b2-1fa9840a6dfe', 125, '[123]', 'WEEKLY', 1, 0, NULL, '[0, 1, 3, 4, 5, 6]', NULL, '2026-04-01', '2027-03-31', '2026-05-03'),
...
('ab287c39-3d93-40b3-840d-3f0576f59122', 'b0f17486-efdb-4857-8b4d-7fee10ecb412', NULL, '2, A Building,', 'Bangalore', 'Karnatraka', 1, '2026-04-01 16:59:23', '2026-04-01 16:59:23', 'Hebbal');
...
(120, 'Abhi', 'chandan@psops.com', 'test', '$2b$10$8RfiD3f233PliGOz1iqTvemvnCL1Pll9LCCfy1HAMXlHw0lbOMt7S', 'supervisor', 1, '2026-04-01 12:30:33', '2026-04-01 12:41:06', NULL, NULL, NULL, NULL, '12e69a76-2c18-11f1-9615-72ed8d604cd2'),
...
--
ALTER TABLE `job_tickets`
  ADD CONSTRAINT `fk_ticket_job` FOREIGN KEY (`job_id`) REFERENCES `jobs` (`id`) ON DELETE CASCADE,
